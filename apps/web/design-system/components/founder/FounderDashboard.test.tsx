...
function makeMetrics(o: Partial<AdministrationMetricsDto> = {}): AdministrationMetricsDto {
  return {
    ...
    aiSpendByCapability: [{ capability: 'RECOMMENDATION', totalCostUsd: 12.34, requestCount: 88, failedCount: 2 }],
    orchestrationRunsToday: 5,
    orchestrationRunsByGoal: [{ goal: 'NEXT_BEST_ACTION', count: 5 }],
