  ...
  async createPlan(
    ...
    const plan = await this.repo.createPlan({
      plan: {
        ...
        retentionExpiresAt: new Date(Date.UTC(dto.taxYear + 8, 0, 1)),
        status,
        blockReasons,
        projectedCashInCents,
        projectedCashOutCents,
  ...
  async listProfileReviewQueue() {
    ...
    return profiles.map((profile) => {
      ...
      return {
        ...
        kind: profile.kind,
        jurisdictionCountry: profile.jurisdictionCountry,
        ...
        projectedCashInCents: profile.projectedCashInCents,
        projectedCashOutCents: profile.projectedCashOutCents,
        projectedTaxableWinningsCents: profile.projectedTaxableWinningsCents,
        projectedDeductibleLossesCents: profile.projectedDeductibleLossesCents,
        playthroughRequiredCents: profile.playthroughRequiredCents,
        defaultUnitWagerCents: profile.defaultUnitWagerCents,
        estimatedActionsPerMinute: profile.estimatedActionsPerMinute,
