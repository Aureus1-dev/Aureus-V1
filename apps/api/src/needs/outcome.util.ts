...
const CONCISE_NEEDS_WITH_ACTIONABLE_DEFAULTS = new Set([
  'money', 'cash', 'income', 'bills', 'debt', 'rent', 'mortgage', 'housing', 'homeless',
  'food', 'groceries', 'job', 'work', 'employment', 'benefits', 'healthcare', 'health care',
  'doctor', 'medicine', 'medication', 'transportation', 'transport', 'car', 'childcare',
  'child care', 'school', 'education', 'legal', 'lawyer', 'safety', 'utilities', 'electric',
  'gas', 'water',
]);
