...
export class UpdateProfileDto {
  ...
  @ApiPropertyOptional({
    example: 'Austin',
    description: 'Coarse location only — never precise geolocation',
  })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  ...
  @ApiPropertyOptional({
    ...
    description: 'A metro area, county, or district — not always equal to state',
  })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  ...
  @ApiPropertyOptional({
    description: 'Free text: describe the community area you consider local to you',
    maxLength: 500,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    enum: SeasonOfLife,
    description: 'A current season, never a permanent category. No season is ranked above another.',
  })
  @IsOptional()
  @IsEnum(SeasonOfLife)
  ...
  @ApiPropertyOptional({
    description: 'Voluntary only — never defaulted, never required',
    maxLength: 200,
  })
  @IsOptional()
  @IsString()
