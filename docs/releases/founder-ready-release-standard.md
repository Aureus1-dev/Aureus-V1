# Founder-Ready Release Evidence Standard

**Status:** Founder-approved operating standard, effective 2026-08-11.

## Rule

No Aureus build may be offered to any person outside the Founder-only test boundary until the exact deployed candidate has passed every automated gate below and the Founder has completed and recorded the human walkthrough. A green build is necessary evidence; it is not release approval.
...
9. Founder walkthrough result, defects found, fixes made, retest evidence, and explicit Founder decision: `HOLD` or `RELEASE`.
...
- a known release-blocking defect is waived without a written Founder decision.
...
3. **Founder check:** the Founder completes the same critical journeys as a human, records results, and is the only release authority during the Founder-only pilot.

No step may substitute for another.

## Founder walkthrough minimum

The Founder must personally verify:
...
The Founder signs only after every blocker is fixed and the exact deployment is retested.

## Recurrence

This standard applies to every production release, provider/model change, authentication change, schema migration, permission change, and re-enabling of a previously gated surface. Any defect found by the Founder becomes a permanent automated regression test whenever technically possible and a permanent manual checklist item when it is not.
